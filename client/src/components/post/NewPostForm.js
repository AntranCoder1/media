...
const NewPostForm = () => {
    ...
    const error = useSelector(state => state.ErrorRedux.postError);
                    ...
                    <div className="post-form">
                        ...
                        <div className="footer-form">
                            ...
                            <div className="btn-send">
                                    {message || postPicture || video.length > 20 ? (
                                        <button className="cancel" onSubmit={cancelPost}>Cancel message</button>
                                    ) : null}
                                <button className="send" onSubmit={handlePost}>To send</button>
                            </div>
                        </div>
                    </div>
                </>
